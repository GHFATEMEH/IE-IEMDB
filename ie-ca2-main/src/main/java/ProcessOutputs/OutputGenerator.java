...
public class OutputGenerator {
    ...
    public String generateMoviesOutput(ArrayList<String> data) throws IOException {
        File htmlTemplateFile = new File("./src/main/java/ProcessOutputs/templates/movies.html");
        String content = FileUtils.readFileToString(htmlTemplateFile, "UTF-8");
        content = content.replace("$movies_info", makeMoviesInfo(data));
        return content;
    }
    ...
    private String makeMoviesInfo(ArrayList<String> moviesInfo) {
        String data = "";
