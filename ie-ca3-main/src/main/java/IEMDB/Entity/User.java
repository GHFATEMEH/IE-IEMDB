...
public class User extends Entity{
    ...
    public void addMovieToWatchList(Movie movie) throws AgeLimitError, MovieAlreadyExists {
    ...
    public ArrayList<Movie> getMoviesInWatchList() {
        return watchList.getMovies();
    }

    public WatchList getWatchListField() {return watchList;}
}
